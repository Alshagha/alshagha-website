    ...
    const figures = [
        {
            ...
            born: "١٢٣٠ هـ - عنيزة",
            desc: "محمد بن منصور بن محمد ابن حمود العفراني الحتيرشي الهذلي (الملقب بالشقحاء). وسبب تسميته بالشقحاء لأنه يمتلك إبل شقح وقد عرف بها وأصبح يطلق عليه محمد ابن حمود راعي الشقحاء، وبناء عليه التصق هذا اللقب بذريته الى وقتنا الحاضر. \n\nنشأ في كنف والديه وفي أسرة مترابطه وذات شأن، وهو أكبر اخوته صالح وعبدالرحمن، وامه هي سلمى بنت محمد بن سعد ابن القائد ابراهيم ابن عفيصان العايذي القحطاني ولي اميرا لمدينة عنيزه عام ١٢٢٥ وتوفي فيها ١٢٢٩ ، وزوجته زبيدة بنت محمد العماري. له ثلاثة أبناء منصور، علي، وعبدالرحمن.",
