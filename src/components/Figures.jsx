...
const Figures = () => {
    ...
    const figures = [
        ...
        },
        {
            ...
            highlights: "عندما علم الملك عبد العزيز رحمه اللّٰه بسعة خبرته العسكرية كلفه ببعض المهام العسكرية. ومن ذلك قائدًا عسكريًّا في جيزان، ثم عُين أميرًا على جيزان، بعد أنتهاء الحرب مع اليمن ، ثم تولى بعض المهام العسكرية في أبها والمنطقة الجنوبية ، ثم في الحدود الشمالية، وبعد ذلك عُين أميرًا لمدينة الوجه، ثم عاد كقائد للجيش في حائل. واستمر مزاولًا للعمل العسكري بإخلاص حتى توفي وهو على رأس العمل عام ١٣٧١ هجري ومات في محافظة جدة حيث (نقل باخلاء طبي ) أثر مرض ذات الجنب الذي أصيب به في حائل من جراء البرد القارس ، ودفن في مقبرة أمنا حواء حسب توجيهات سمو وزير الدفاع آنذاك ، مخلفًا سمعة حسنة. رحمهم الله جميعا وغفر لهم وجميع موتى المسلمين.",
        ...
        },
        {
            ...
            born: "بريدة",
            desc: "الأمير منصور بن محمد المنصور الشقحاء،المولود في مدينة بريدة بمنطقة القصيم، ونشأ بها، عمل في بداية حياته بالتجارة وشارك مع والده في رحلات العقيلات، عينه الملك المؤسس عبدالعزيز بن عبدالرحمن آل سعود أميرًا لرجال ألمع بعسير، ثم أميرًا على القحمة، ثم أميرًا على بيش، وتوفى ودفن في مدينة جيزان عام ١٣٦٨ هـ رحمه الله.",
            highlights: "",
            icon: <GiCrown />,
            testaments: [
