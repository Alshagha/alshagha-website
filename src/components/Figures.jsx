    ...
    const figures = [
        {
            ...
            born: "١٢٣٠ هـ - عنيزة",
            desc: "محمد بن منصور بن محمد ابن حمود العفراني الحتيرشي الهذلي (الملقب بالشقحاء). وسبب تسميته بالشقحاء لأنه يمتلك إبلًا شقح وقد عرف ب إحداها وأصبح يطلق عليه راعي الشقحاء، وبناء عليه غلب هذا اللقب على ذريته إلى وقتنا الحاضر. \n\nنشأ في كنف والديه وفي أسرة مترابطة وذات شأن، وهو أكبر اخوته صالح وعبدالرحمن، وامه هي سلمى بنت محمد ابن عفيصان، وزوجته زبيدة بنت محمد العماري. له ثلاثة أبناء: منصور، علي، وعبدالرحمن.",
            highlights: "اشتهر الشيخ محمد بالتجاره. ويوجد حاليا اوقاف واملاك له بعنيزة تعرف بـ قيصرية الشقحاء يقف عليها ناظر من آحفاده، وتوجد له وصية تعد من اهم وثائق الأسرة بتاريخ ١٢٦١ آوصى رحمه الله بعدة وآوجه خير ومازالت ولله الحمد تطبق على أكمل وجه. توفي رحمه الله بعنيزه عام ١٢٩٣ عن عمر يناهز ٦٣ سنه رحمه الله رحمة واسعه.",
            icon: <GiCrown />,
            testaments: [
