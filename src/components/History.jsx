                ...
                <div className="history-timeline">
                    ...
                    <div className="timeline-item right fade-in-up delay-2">
                        ...
                        <div className="timeline-content glass-panel">
                            ...
                            <p className="card-text">
                                الموطن الأصلي لألسرة ومسقط الرأس هي محافظة عنيزة الواقعة في قلب منطقة القصيم، فهي المقر
                                التاريخي ألسرة الشقحاء.
                                وقد استقر فيها الجد الشيخ حمود الحتيرشي الهذلي بعد قدومه مع أسرته من الحجاز من وادي الصدر
                                (صدر حنين) إلى نجد، وتنقل ه ما بين مدنها حتى استقر في عنيزة في عام 1220هـ                            </p>
                        </div>
                    </div>
