        ...
        <section className="history section-padding" id="history">
            <div className="container">
                ...
                <p className="section-subtitle text-center">
                    تعد أسرة الشقحاء وفرعها أسرة المنصور من الأسر النجدية، التي تنتمي إلى أسر آل حمود المعروفة التي ترجع إلى خامس العفران من الحتارشة من قبيلة هذيل؛
                ...
                <div className="history-timeline">
                    ...
                    >
                        ...
                        <div className="timeline-content glass-panel">
                            ...
                            <p className="card-text">
                                استقر الجد الشيخ منصور بن محمد ابن حمود في مدينة عنيزة وتوفي فيها رحمه الله. وقد خلف ثلاثة أبناء هم: محمد، صالح (لهما ذرية)، وناصر (انقطعت ذريته)،
                                رحمهم الله جميعًا.
                            </p>
                        </div>
                    </motion.div>
